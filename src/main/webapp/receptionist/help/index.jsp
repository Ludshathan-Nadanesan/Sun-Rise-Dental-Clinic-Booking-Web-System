...
<head>
    <meta charset="UTF-8">
    <title>Help Guide - Receptionist Dashboard</title>
...
<body class="bg-gray-50 dark:bg-gray-900 transition-colors duration-300 min-h-screen">
    ...
    <main class="p-8 max-w-7xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
            <div>
                <h2 class="text-3xl font-bold text-gray-800 dark:text-white">Receptionist Help Guide</h2>
                <p class="text-gray-500 dark:text-gray-400 mt-2">Find step-by-step instructions on how to manage patients and appointments.</p>
            </div>
            
            <div class="w-full md:w-96 relative">
                <input type="text" id="searchInput" onkeyup="filterTopics()" placeholder="Search help topics (e.g. 'bill')..."
